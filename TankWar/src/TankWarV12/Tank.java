...
public class Tank {
    ...
    public Tank(int x, int y, int width, int height, Color color, boolean isGood, int curValue, int maxValue, TankWar tankWar) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public void fire(){
        // 传出bullet给 tankWar ！
        Bullet bullet = new Bullet(x+(width/2), y+(height/2),ptDir,tankWar,isGood);
